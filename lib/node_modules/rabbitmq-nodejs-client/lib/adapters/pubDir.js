//     lib/adapters/pubDir.js v0.0.1
//     (c) 2012 Adriano Raiano (adrai); under MIT License

// This adapter acts as publisher for a direct routekey pub/sub topology.
...
(function(S) {
    ...
    P._init = function(callback) {
        ...
        if (!this.hub.options.channel){
            this.hub.connection.exchange('amq.direct', {passive: true}, handle);
        } else {
            this.hub.connection.exchange(this.hub.options.channel, {type: 'direct', autoDelete: true}, handle);
        }
